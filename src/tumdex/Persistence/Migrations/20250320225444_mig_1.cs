        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcMenuId = table.Column<string>(type: "text", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VaryantGroupID = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EndpointsId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    LikeDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedPrice = table.Column<decimal>(type: "numeric", nullable: true),
                    LeadTime = table.Column<int>(type: "integer", nullable: true),
                    PriceUpdateDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductId = table.Column<string>(type: "text", nullable: false),
                    FeatureValueId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ImageFiles_CartItems_CartItemId",
                        column: x => x.CartItemId,
                        principalTable: "CartItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ImageFiles_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "BrandBrandImageFile",
                columns: table => new
                {
                    BrandImageFilesId = table.Column<string>(type: "text", nullable: false),
                    BrandsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandBrandImageFile", x => new { x.BrandImageFilesId, x.BrandsId });
                    table.ForeignKey(
                        name: "FK_BrandBrandImageFile_Brands_BrandsId",
                        column: x => x.BrandsId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandBrandImageFile_ImageFiles_BrandImageFilesId",
                        column: x => x.BrandImageFilesId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CategoriesId = table.Column<string>(type: "text", nullable: false),
                    CategoryImageFilesId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCategoryImageFile", x => new { x.CategoriesId, x.CategoryImageFilesId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductImageFilesId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandBrandImageFile_BrandsId",
                table: "BrandBrandImageFile",
                column: "BrandsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryCategoryImageFile_CategoryImageFilesId",
                table: "CategoryCategoryImageFile",
                column: "CategoryImageFilesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageFiles_CartItemId",
                table: "ImageFiles",
                column: "CartItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageFiles_OrderItemId",
                table: "ImageFiles",
                column: "OrderItemId");
